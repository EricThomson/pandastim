...
Event handling: http://www.panda3d.org/manual/?title=Event_Handlers&oldid=3446
Mouse modes example: 
...
class FullFieldDriftInputExperiment(ShowBase):
    ...
    def __init__(self, stim_params, texture_functions,
        ...
        self.toggle_button = KeyboardButton.ascii_key('t')
    ...
    def set_texture_task(self, task):
        ...
        is_down = ShowBaseGlobal.base.mouseWatcherNode.is_button_down
        if is_down(self.toggle_button):
            print("toggle")
        return task.cont
...
#            return task.done
    ...
    def move_texture_task(self, task):
        """doc here
        Note this velocity hack is temporary need to do something more like what you
        did with binocular drift"""
        pass
#        if task.time <= self.stim_change_times[-1]:
