...
class KeyboardToggleStim(ShowBase):
    ...
    def create_masked_stim(self):
        ...
        #CREATE CARD
        cm2 = CardMaker('stimcard')
        cm2.setFrameFullscreenQuad()
        self.setBackgroundColor((0,0,0,1))
        self.left_card = self.aspect2d.attachNewNode(cm2.generate())
        ...
        self.left_mask_array[:, self.texture_size//2 - 3 :] = 0
...
if __name__ == '__main__':
    ...
    stim_params = [{'type': 'single', 'angle': 45},
                   {'type': 'double', 'angle': -45}]
