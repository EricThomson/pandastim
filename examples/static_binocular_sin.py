# -*- coding: utf-8 -*-
"""
pandastim/examples/drifting_binocular_sin.py
Example of how to present a drifting binocular grating. Left his 
horizontal (90 degrees) right is vertical (0 degrees)
